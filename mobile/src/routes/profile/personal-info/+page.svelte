  ...
  <form onsubmit={handleSave} class="flex flex-col gap-3 mt-2">
    <Card>
      <div class="flex flex-col gap-4">
        <div>
          <label for="name" class="block text-[11px] text-text2 mb-1"
            >Full Name</label
          >
          <input
            id="name"
        ...
        <div>
          <label for="email" class="block text-[11px] text-text2 mb-1"
            >Email</label
          >
          <input
            id="email"
            type="email"
            bind:value={email}
            class="w-full p-2.5 bg-glass2 border border-border rounded-lg text-sm text-text0 outline-none focus:border-blue opacity-50"
            disabled
          />
        </div>
        <div>
          <label for="dob" class="block text-[11px] text-text2 mb-1"
            >Date of Birth</label
          >
          <input
            id="dob"
        ...
        <div>
          <label for="gender" class="block text-[11px] text-text2 mb-1"
            >Gender</label
          >
          <select
            id="gender"
            bind:value={gender}
            class="w-full p-2.5 bg-glass2 border border-border rounded-lg text-sm text-text0 outline-none focus:border-blue appearance-none"
          >
            <option>Male</option>
    ...
    <Card>
      ...
      <div class="flex gap-3">
        <div class="flex-1">
          <label for="weight" class="block text-[11px] text-text2 mb-1"
            >Weight (kg)</label
          >
          <input
            id="weight"
        ...
        <div class="flex-1">
          <label for="height" class="block text-[11px] text-text2 mb-1"
            >Height (cm)</label
          >
          <input
            id="height"
    ...
    <button
      type="submit"
      class="w-full py-3.5 bg-blue text-white font-semibold rounded-xl hover:bg-[#3d1ae6] transition-colors mt-2"
    >
      Save Changes
    </button>
  </form>
