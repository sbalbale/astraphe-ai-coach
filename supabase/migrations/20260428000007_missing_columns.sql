...
ALTER TABLE biometrics ADD COLUMN IF NOT EXISTS astrape_readiness_score SMALLINT;
ALTER TABLE biometrics ADD COLUMN IF NOT EXISTS astrape_strain_score SMALLINT;
