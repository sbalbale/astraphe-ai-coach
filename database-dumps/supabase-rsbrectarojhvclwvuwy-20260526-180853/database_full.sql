...
\restrict shi6pnvRfUJixEZOYH3IYmTf3PmYYLI3v0nnsrxDfM2Kga9WqgYzJxgcRZxcPNi
...
\unrestrict shi6pnvRfUJixEZOYH3IYmTf3PmYYLI3v0nnsrxDfM2Kga9WqgYzJxgcRZxcPNi
\connect "postgres"
\restrict shi6pnvRfUJixEZOYH3IYmTf3PmYYLI3v0nnsrxDfM2Kga9WqgYzJxgcRZxcPNi
...
--
-- Name: coach_memories; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE "public"."oauth_tokens" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "oauth_tokens_provider_check" CHECK (("provider" = ANY (ARRAY['garmin'::"text", 'whoop'::"text"])))
);
...
--
-- Name: tss_history; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: biometrics biometrics_athlete_id_record_date_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."biometrics"
    ADD CONSTRAINT "biometrics_athlete_id_record_date_key" UNIQUE ("athlete_id", "record_date");
...
--
-- Name: coach_memories coach_memories_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: oauth_tokens oauth_tokens_athlete_provider_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: tss_history tss_history_athlete_id_record_date_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."tss_history"
    ADD CONSTRAINT "tss_history_athlete_id_record_date_key" UNIQUE ("athlete_id", "record_date");


--
-- Name: tss_history tss_history_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: athletes athletes_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: biometrics biometrics_athlete_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."biometrics"
    ADD CONSTRAINT "biometrics_athlete_id_fkey" FOREIGN KEY ("athlete_id") REFERENCES "public"."athletes"("id");


--
-- Name: coach_memories coach_memories_athlete_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."coach_memories"
    ADD CONSTRAINT "coach_memories_athlete_id_fkey" FOREIGN KEY ("athlete_id") REFERENCES "public"."athletes"("id");


--
-- Name: oauth_tokens oauth_tokens_athlete_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: training_plans training_plans_athlete_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: tss_history tss_history_athlete_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."tss_history"
    ADD CONSTRAINT "tss_history_athlete_id_fkey" FOREIGN KEY ("athlete_id") REFERENCES "public"."athletes"("id");


--
-- Name: workouts workouts_athlete_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: biometrics; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."biometrics" ENABLE ROW LEVEL SECURITY;

--
-- Name: coach_memories; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: tss_history; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "biometrics"; Type: ACL; Schema: public; Owner: postgres
--

GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."biometrics" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."biometrics" TO "authenticated";
GRANT ALL ON TABLE "public"."biometrics" TO "service_role";


--
-- Name: TABLE "coach_memories"; Type: ACL; Schema: public; Owner: postgres
--

GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."coach_memories" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."coach_memories" TO "authenticated";
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."training_plans" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."training_plans" TO "authenticated";
GRANT ALL ON TABLE "public"."training_plans" TO "service_role";


--
-- Name: TABLE "tss_history"; Type: ACL; Schema: public; Owner: postgres
--

GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."tss_history" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."tss_history" TO "authenticated";
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."workouts" TO "authenticated";
